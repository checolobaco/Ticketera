  ...
  return (
    <div style={{ maxWidth: 860, margin: '0 auto', padding: '10px 15px' }}>
      <div className="app-card" style={{ padding: '30px', borderRadius: 20 }}>
        ...
        {/* Sección 7: Ley 1493 */}
        <div className="ticket-card" style={{ marginBottom: 24, padding: 20, background: '#FEF3C7', border: '1px solid #FCD34D', borderRadius: 14 }}>
          <h2 style={{ fontSize: 18, fontWeight: 700, color: '#92400E', marginTop: 0, marginBottom: 12 }}>
            7. Naturaleza del Servicio y Exención Ley 1493 de 2011
          </h2>
          <p style={{ fontSize: 14, color: '#78350F', lineHeight: 1.7, margin: 0 }}>
            <strong>CloudTickets (cloud-tickets.com)</strong> es una plataforma de infraestructura tecnológica y software como servicio (SaaS). CloudTickets NO actúa como operador de boletería, tiquetera pública ni organizador de espectáculos públicos en los términos de la Ley 1493 de 2011. La responsabilidad sobre el registro PULEP del evento, comercialización de entradas, retención y pago de tributos o contribuciones parafiscales recae de manera exclusiva e independiente en los Organizadores de cada evento.
          </p>
        </div>
